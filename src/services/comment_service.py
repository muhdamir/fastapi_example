...
class CommentService:
    ...
    def search_2(self, user_input:str):
        ...
        # searching process
        condition_1 = selected_data["email"].str.lower().str.contains(str_input := user_input.lower() if user_input else "")
        ...
        condition_4 = (selected_data["postId"] == int(user_input)) if user_input.isnumeric() else False
        condition_5 = (selected_data["id"] == int(user_input)) if user_input.isnumeric() else False
